        ...
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="base_pay" name="base_pay">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="leave_credits" class="col-sm-3 control-label">Leave credits</label>
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="leave_credits" name="leave_credits">
                    </div>
                </div>
          	</div>
          	<div class="modal-footer">
            	<button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
            	<button type="submit" class="btn btn-primary btn-flat" name="add"><i class="fa fa-save"></i> Save new position</button>
            	</form>
          	</div>
        </div>
    </div>
        ...
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_base_pay" name="base_pay">
				...
				<div class="form-group">
                    <label for="edit_leave_credits" class="col-sm-3 control-label">Leave credits</label>
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_leave_credits" name="edit_leave_credits">
                    </div>
                </div>
          	</div>
          	<div class="modal-footer">
            	<button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
            	<button type="submit" class="btn btn-success btn-flat" name="edit"><i class="fa fa-check-square-o"></i> Update position</button>
            	</form>
          	</div>
        </div>
    </div>
...
<div class="modal fade" id="delete">
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-footer">
            	<button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
            	<button type="submit" class="btn btn-danger btn-flat" name="delete"><i class="fa fa-trash"></i> Delete position</button>
            	</form>
          	</div>
        </div>
    </div>
