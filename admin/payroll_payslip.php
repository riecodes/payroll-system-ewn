...
<div class="wrapper">
  ...
  <?php
        ...
        cash.number_of_cutoffs AS number_of_cutoffs,
        pe.pay_per_cut_off AS pay_per_cut_off_pe,
        pe.gross AS gross,
        ...
        LEFT JOIN (
          ...
          ORDER BY id DESC 
          LIMIT 1
        ) AS cash ON cash.employee_id = pe.employee_id
        WHERE em.archive = 'no' AND pe.id='".$_GET['id']."' 
        LIMIT 1";
          ...
          <div class="box">
                ...
                <div class="col-sm-4">
                  <div class="box-body">
                        ...
                        <div class="form-group row ">
                        <input type="hidden" class="form-control" id="number_of_cutoffs" name="number_of_cutoffs" value="<?php echo $row['number_of_cutoffs'] ?>">
                              <label for="pay_per_cut_off" class="col-sm-3 col-form-label">Cash advance deduction</label>
                              <div class="col-sm-9">
                                <?php 
                                  if((float)$row['cashadvance_balance']>0){
                                ?>
                                <input type="text" class="form-control" id="pay_per_cut_off" name="pay_per_cut_off" value="<?php echo $row['pay_per_cut_off'] ?>">
                                <input type="hidden" class="form-control" id="pay_per_cut_off" name="hidden_pay_per_cut_off" value="<?php echo $row['pay_per_cut_off'] ?>" style="border:1px solid red">
                                <?php }else{?>
                ...
                <div class="col-sm-4">
                  <div class="box-body">
                        ...
                        <div class="form-group row ">
                              <label for="pay-per-cut-off" class="col-sm-3 col-form-label">Pay per cut off</label>
                              <div class="col-sm-9">
                                <input type="text" class="form-control" id="pay-per-cut-off" name="pay-per-cut-off" value="<?php echo (float)$row['pay_per_cut_off_pe'] ?>" readonly>
                              </div>
                        </div>
